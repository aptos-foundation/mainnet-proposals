...
script {
    ...
    fun main(proposal_id: u64) {
        ...
        let execution_blob: vector<u8> = x"070420000000000000000000000000000000040000000000000002307500000000000001000000000000000100000000000000090000000001010000500000000000010101015a0000000000000001";
