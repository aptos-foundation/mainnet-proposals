...
script {
    ...
    fun main(proposal_id: u64) {
        let framework_signer = aptos_governance::resolve_multi_step_proposal(
            proposal_id,
            @0x1,
            x"9ceb7e51524e18ef8d570e9449c0a14b60701655c4143b900e51eea0be05e99a",);
        let execution_blob: vector<u8> = x"070420000000000000000000000000000000040000000000000002307500000000000001000000000000000100000000000000090000000001010000500000000000010100015a0000000000000001";
