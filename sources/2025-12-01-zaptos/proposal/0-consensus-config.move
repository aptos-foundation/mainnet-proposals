...
script {
    ...
    fun main(proposal_id: u64) {
        ...
        let consensus_blob: vector<u8> = x"0402010a0000000000000064000000000000000201e8030000000000000a0000000000000001000000000000000a0000000a00000000000000010000000000000001050000000a00000000000000010101030000000000000000002000000000000001";
