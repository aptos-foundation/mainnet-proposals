...
script {
    ...
    fun main(proposal_id: u64) {
        let framework = aptos_governance::resolve_multi_step_proposal(
            proposal_id,
            @0x1,
            vector[122u8,192u8,253u8,37u8,187u8,155u8,22u8,236u8,255u8,105u8,100u8,119u8,210u8,57u8,210u8,210u8,84u8,45u8,23u8,253u8,165u8,51u8,183u8,36u8,189u8,122u8,196u8,162u8,32u8,1u8,217u8,118u8,],
        );
